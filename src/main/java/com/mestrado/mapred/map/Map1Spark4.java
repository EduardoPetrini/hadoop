 ...
 * @author eduardo
 */
public class Map1Spark4 implements Function2<Integer, Iterator<String>, Iterator<Tuple2<String,SupPart>>> {
	...
	public Map1Spark4(double support, List<String> itemsets) {
